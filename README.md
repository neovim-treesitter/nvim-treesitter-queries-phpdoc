# nvim-treesitter-queries-phpdoc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-phpdoc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-phpdoc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **phpdoc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-phpdoc",
...
- [ ] Changes are scoped to `phpdoc` — do not include files for other languages
